...
from networkml.requirementterm import RequirementTerm, RequirementTermOption, ActionRequirement, ExistenceRequirement
from networkml.requirementterm import ActionScript
